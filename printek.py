...
import os
# import minecart
rysunek = '267-ML-106X-SD-05.pdf'

path = os.listdir(r'C:\Users\pmantiuk\Desktop\druki formatówka')

# print(path)

with open(rysunek, "rb") as in_f:
...
#--- wydruk pomocniczy do określenia prawej krawędzi wydruku oraz upewnienia się, że obszar zawiera ściany
    ...
    for i in range(numPages):
        ...
        print (page.mediaBox.getLowerLeft(), page.mediaBox.getUpperRight())

        print(f'wysokość rysunku: {page.mediaBox.getHeight()}')
        print(f'szerokość rysunku: {page.mediaBox.getWidth()}')
        # page.trimBox.lowerLeft = (0, 0)
        # page.trimBox.upperRight = (1225, 225)
        page.cropBox.lowerLeft = (1582, 1500)
        page.cropBox.upperRight = (2384, 3370)
        output.addPage(page)
